      ...
      renderCell: (params) => {
        return (
          <div className="flex gap-2">
            <Link to={`/recruiters/${params.row._id}`} className="border rounded-md  p-[5px] w-[30%] h-10 mt-2 flex items-center text-blue-700  hover:border-blue-700 cursor-pointer">
              View
            </Link>
            <button
